<template>
	<view class="container">
		...
		<u-notice-bar mode="horizontal" :is-circular="false" :list="noticeList" :duration="4000" :more-icon="true"></u-notice-bar>		<u-sticky class="top">
			<view class="search">
		...
		methods: {
			...
			init: function() {
				...
				if (this.current === 0){
					...
					uni.request({
					    url: getApp().globalData.shopping,
						data: params
					    success: (res) => {
							console.log('shopping res',res);
